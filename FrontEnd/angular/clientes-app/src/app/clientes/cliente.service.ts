...
//Una vez importado HttpClientModule en AppModule importamos : HttpClient
//Para realizar peticiones http al cervidor : Api Rest
...
/*private agregarAuthorizationHeader() {
  ...
  //Version anterior de "getClientes" sin paginado
